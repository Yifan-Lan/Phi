...
if __name__ == "__main__":
    ...
    wandb.init(
      project="Phi",
      name=f"universal_border_num{num_iter}_os{output_size}_ap{attack_power}_a{alpha}_bs{training_args.per_device_train_batch_size}_ba{training_args.gradient_accumulation_steps}",
      config={
      "num_iter": num_iter,
