...
class Trainer:
    ...
    def __init__(
        ...
        train_dataset_original: Optional[Union[Dataset, IterableDataset, "datasets.Dataset"]] = None,
        eval_dataset_original: Optional[Union[Dataset, Dict[str, Dataset], "datasets.Dataset"]] = None,
